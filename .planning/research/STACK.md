...
**Domain:** Multi-tenant SaaS digital menu (cardápio digital) for restaurants
**Researched:** 2026-06-15
**Confidence:** HIGH (core framework/DB/auth choices verified against npm registry + official docs); MEDIUM (Next.js 16 ecosystem maturity, since it's a recent major release)
...
npx create-next-app@latest cardapio-boamidia --typescript --tailwind --eslint --app

# Core data/auth
npm install @supabase/supabase-js @supabase/ssr drizzle-orm postgres

# Validation & forms
npm install zod react-hook-form @hookform/resolvers libphonenumber-js

# UI components (after create-next-app, init shadcn)
npx shadcn@latest init
npx shadcn@latest add button input dialog form table sheet badge dropdown-menu
...
**If the team wants the absolute simplest data layer for v1 (no ORM):**
...
**If multi-photo galleries per product become a requirement:**
...
**If the platform later adds online payment or order persistence (explicitly out of scope for v1):**
...
---
*Stack research for: Multi-tenant digital menu SaaS (Boa Mídia)*
*Researched: 2026-06-15*
